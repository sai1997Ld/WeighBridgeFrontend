...
const ManagementGateExit = ({ onConfirmTicket = () => {} }) => {
  ...
  useEffect(() => {
    // Initial fetch
    fetch(
      "http://localhost:8080/api/v1/management/transactions/ongoing?transactionType=outbound&vehicleStatus=completed&companyName=${selectedCompany}&siteName=${siteName}&page=${pageNumber}",
      {
        credentials: "include",
      }
    )
